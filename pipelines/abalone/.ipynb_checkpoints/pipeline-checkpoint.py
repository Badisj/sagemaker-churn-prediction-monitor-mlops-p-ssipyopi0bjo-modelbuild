...
def get_pipeline(
    ...
    input_data = ParameterString(
        name="InputDataUrl",
        default_value=f"s3://sagemaker-mlops-datasets-raw/{base_job_prefix}/data/raw/abalone-dataset.csv",
    )
    ...
    checks_path = f"s3://{default_bucket}/{base_job_prefix}/checks/{ExecutionVariables.PIPELINE_EXECUTION_ID}"
    ...
    model_path = model_path = f"s3://{default_bucket}/{base_job_prefix}/models"
    ...
    pipeline = Pipeline(
        ...
        parameters=[
            ...
            # Data quality for baseline and monitoring 
            ...
            # Post-training bias for baseline and monitoring
